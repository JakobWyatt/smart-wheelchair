...
and training. The recall metric (true positive rate, $\frac{tp}{tp + fn}$) was used to quantify the model's
performance on sidewalks and roads separately, for comparison.
...
The approach specified in \cref{eq:tilt_filter} was also tested to identify the drivable area.
...
sensor tilt remains constant.

\begin{align}
\mathrm{Note that p_z is -ve in front of wheelchair}\\
