...
\begin{adjustbox}{width=\textwidth}
    ...
    \toprule
    Name & Type & Cost (AUD)\footnote[1]{Costs are taken at RRP with an exchange rate of 1 AUD = 0.74 USD} & Dimensions (mm) & FOV (Horizontal, Vertical, Depth) & Operating Range (m) \\
    \midrule
...
Once an understanding of the 3d scene has been built, 
% Inputs
% Semi-autonomy
% Full autonomy
% Path Planning
...
Part of the current work this semester has included sensor and compute element selection, as well as dataset collection.
