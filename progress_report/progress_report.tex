...
alongside the wheelchair have been identified and ordered.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\linewidth,angle=270,origin=c]{images/wheelchair.jpg}
...
provides good compatibility with existing machine learning models.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{images/deeplab.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{images/hybridnets_outdoor.png}
...
with the occupancy grid and Lidar scan visualised in \cref{fig:simulated_lidar}.
...
\Cref{fig:vfh_controller} shows a visualisation of the VFH+ controller successfully avoiding nearby
